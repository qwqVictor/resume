...
- Proficient in *shell*, *Python*, *JavaScript* and *TypeScript*, conversational in *C/C++*, and have basic knowledge of *Golang*, *PHP* and *Java*. Can independently develop using these PLs.
+ Capable to write scripts for automatical maintenance and full-stack develop a small project.
...
- Understand part of compilation theory. Capable to write simple compiler frontend or parsing a DSL.
...
- 🥇13th Lanqiao Contest (C/C++) in Provinces: **1st award** in group B`]
        ...
        details: [`
- HomeIDC: Be a geek! Got a 2nd-handed server at home. Based on Proxmox VE, I built NAS system with Samba, build the SSO with Active Directory and Keycloak. Used K3S and [Personal blog](https://qwq.ren) is running on the infra.
